;;; doom-nordic-theme.el --- darker variant of doom-nordic -*- lexical-binding: t; no-byte-compile: t -*-
;;
;; Author:  <arthank@ASIMOV>
;; Maintainer:
...
(defcustom doom-nordic-brighter-modeline nil
...
(defcustom doom-nordic-comment-bg doom-nordic-brighter-comments
...
(eval-and-compile
  (defcustom doom-nordic-region-highlight t
...
(def-doom-theme doom-nordic
  ...
  ((bg         '("#2E3440" nil       nil            ))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if doom-nordic-brighter-comments dark-cyan (doom-lighten base5 0.2)))
   (doc-comments   (doom-lighten (if doom-nordic-brighter-comments dark-cyan base5) 0.25))
   (constants      blue)
   (functions      cyan)
   (keywords       blue)
   (methods        cyan)
   ...
   (variables      base7)
   (numbers        magenta)
   (region         (pcase doom-nordic-region-highlight
                     (`frost teal)
                     (`snowstorm base7)
                     (_ base4)))
   (error          red)
  ...
  ((fringe :foreground teal)
   ...
   ((font-lock-comment-face &override)
    :background (if doom-nordic-comment-bg (doom-lighten bg 0.05) 'unspecified))
...
;;; doom-nordicic-theme.el ends here
